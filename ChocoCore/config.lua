...
Config.crouch = false -- Pressing ctrl makes you crouch
Config.tazereffect = true -- Gives you an effect when you get tazed
Config.noreticle = false -- Disables the reticle when aiming
Config.damageragdoll = false-- Ragdoll when shot
Config.fingerpoint = true -- Press b to point
Config.serverlistuptime = false -- Adds a server convar with the server uptime
...
Config.kickplayer = false -- Kick the player if they say a word listed below?
...
Config.servername = "~p~La Frontera ~w~RP" -- Watermark text
...
Config.ragdoll_chance = 0.1 -- Edit this decimal value for chance of falling (e.g. 80% = 0.8    75% = 0.75    32% = 0.32)
...
Config.kickwarning = false -- Warn players if 3/4 of the Time Limit ran up
...
Config.delay = 30 -- Delay before actually deleting all vehicles in seconds
Config.delaymessage = "MASS IMPOUND: All unoccupied vehicles will be deleted after ".. Config.delay .. " seconds" -- Message before deleting all vehicles
Config.deletemessage = "MASS IMPOUND: All unoccupied vehicles have been deleted by a staff member to reduce the amount of server lag and texture loss."
